...
public class DocArtifakt<T,C> {
    ...
    private Consumer<DocArtifakt<T,C>> postConversionAction = (da)->{};
    ...
    public DocArtifakt<T,C> setPostConversionAction(Consumer<DocArtifakt<T,C>> action) {
        this.postConversionAction = action;
        return this;
    }
}
