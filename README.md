...
You might notice that **prjxp** has absolutely zero Javadoc. This isn't an oversight—it's a design philosophy.

> "Chunk Norris doesn't need documentation. Chunk Norris **is** the source of it!"

Since this project is built to understand, chunk, and reconstruct code via LLMs, it is tasked with documenting itself. If you need to know how a method works, just let **Golden-Retriever** fetch the context and **Chunk-Norris** explain it to you.
